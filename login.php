        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($gender)) ? 'has-error' : ''; ?>">
                <label>Login As</label> <br>
				  ...
				  <input type="radio" name="table" <?php if (isset($table) && $table=="JobSeeker") ;?> value="jobseeker">General User
				  <input type="radio" name="table" <?php if (isset($table) && $table=="JobProvider") ;?> value="jobprovider">Premium User
                   <input type="radio" name="table" <?php if (isset($table) && $table=="student") ;?> value="student">Lawyer
